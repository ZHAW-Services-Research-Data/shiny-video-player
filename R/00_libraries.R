...
# Optional - More Widgets----
if (USE_SHINYWIDGETS) {
  if (!require(shinyWidgets)) install.packages('shinyWidgets')
  library(shinyWidgets) # read xlsx
}
...
if (!require(video)) install.packages('video')
library(video)
